...
const FormatLeftIcon = forwardRef(function IconIconComponent(props: IconProps, ref: React.Ref<SVGSVGElement>) {
  return (
    <Icon ref={ref} {...props}>
      <path
...
FormatLeftIcon.defaultProps = {
  fill: "none"
};

FormatLeftIcon.displayName = "FormatLeftIcon";
