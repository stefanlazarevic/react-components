...
const FormatCenterIcon = forwardRef(function IconIconComponent(props: IconProps, ref: React.Ref<SVGSVGElement>) {
  return (
    <Icon ref={ref} {...props}>
      <path
...
FormatCenterIcon.defaultProps = {
  fill: "none"
};

FormatCenterIcon.displayName = "FormatCenterIcon";

export default FormatCenterIcon;