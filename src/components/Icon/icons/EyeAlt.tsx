...
const EyeAltIcon = forwardRef(function EyeAltIconComponent(props: IconProps, ref: React.Ref<SVGSVGElement>) {
  return (
    <Icon ref={ref} {...props}>
      <path
...
EyeAltIcon.defaultProps = {
  fill: "none"
};

EyeAltIcon.displayName = "EyeAltIcon";
