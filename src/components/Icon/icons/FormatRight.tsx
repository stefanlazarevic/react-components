...
const FormatRightIcon = forwardRef(function IconIconComponent(props: IconProps, ref: React.Ref<SVGSVGElement>) {
  return (
    <Icon ref={ref} {...props}>
      <path
...
FormatRightIcon.defaultProps = {
  fill: "none"
};

FormatRightIcon.displayName = "FormatRightIcon";

export default FormatRightIcon;